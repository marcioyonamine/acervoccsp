...
function termosRuins($termo){
	$termos_ruins = array('TÍTULO DA OBRA:','TÍTULO DA PARTITURA:','FORMA/GÊNERO:','TÍTULO DA OBRA:','MEIO DE EXPRESSÃO:','CONTEÚDO:','DESCRITOR GEOGRÁFICO:','DESCRITOR CRONOLÓGICO:','INSTRUMENTAÇÃO:');
...
121 Instrumentação
 ...
 ["Forma/Gênero"]=>
  string(23) "Música Popular - Valsa"
  [61]=>
  string(39) "FORMA/GÊNERO: Música Popular - Valsa "
  ["Resumo Forma/Gênero"]=>
  string(39) "FORMA/GÊNERO: Música Popular - Valsa "
  [62]=>
  string(11) "Voz Solista"
  ["Meio de Expressão"]=>
  string(11) "Voz Solista"
  [63]=>
  string(19) "Instrumento Solista"
  ["Meio de Expressão 2"]=>
  string(19) "Instrumento Solista"
  [64]=>
  string(1) "."
  ...
  string(1) "."
  [65]=>
  string(53) "MEIO DE EXPRESSÃO: Voz Solista e Instrumento Solista"
  ["Resumo Meio de Expressão"]=>
  string(53) "MEIO DE EXPRESSÃO: Voz Solista e Instrumento Solista"
  [66]=>
  string(11) "Voz Solista"
  ["inst01"]=>
  ...
  string(1) "."
  [76]=>
  string(69) "INSTRUMENTAÇÃO: Voz Solista ; Piano ; . ; . ; . ; . ; . ; . ; . ; ."
  ["Resumo Instrumentação"]=>
  string(69) "INSTRUMENTAÇÃO: Voz Solista ; Piano ; . ; . ; . ; . ; . ; . ; . ; ."
  [77]=>
  string(24) "América do Sul - Brasil"
  ["Descritor Geográfico"]=>
  string(24) "América do Sul - Brasil"
  [78]=>
  string(47) "DESCRITOR GEOGRÁFICO: América do Sul - Brasil"
  ["Resumo Descritor Geográfico"]=>
  string(47) "DESCRITOR GEOGRÁFICO: América do Sul - Brasil"
  [79]=>
  string(13) "Séc. 19 e 20"
  ["Descritor Cronológico"]=>
  string(13) "Séc. 19 e 20"
  [80]=>
  string(37) "DESCRITOR CRONOLÓGICO: Séc. 19 e 20"
  ["Resumo Descritor Cronológico"]=>
  string(37) "DESCRITOR CRONOLÓGICO: Séc. 19 e 20"
  [81]=>
  string(1) "."
  ["Assunto"]=>
